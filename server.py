...
import base64 as _b64, hmac as _hmac, hashlib as _hashlib, datetime as _dt
...
def _save_user(email: str, salt_hex: str, hash_hex: str):
    ...
    with open(USERS_LOCAL_PATH, "a", newline="") as f:
        ...
        w.writerow([email, email, salt_hex, hash_hex])  # keep first col as timestamp? some repos used email — harmless
